    ...
    return (
        <form onSubmit={submitHandler} className={styles.container}>
            ...
            <div>
                ...
                <div className={styles.plat}> {randomPlatforms.map((P) => (
                    <div key={P}>
            ...
            <div>
                <label className={styles.title}>Genre: </label>
                <select className={styles.gen} defaultValue='Label' onChange={(e) => handleSelect(e)}>
                    {genres.map((genres) => (
